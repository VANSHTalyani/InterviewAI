...
export const UserProfile: React.FC = () => {
  ...
  const achievements = [
    ...
    { name: 'Consistent Learner', description: '7-day streak', unlocked: progress.streakDays >= 7 },
    { name: 'Improvement Master', description: '15% improvement rate', unlocked: progress.improvementRate >= 15 },
    { name: 'Skilled Speaker', description: 'Average score above 75', unlocked: progress.averageScore >= 75 },
  ];
